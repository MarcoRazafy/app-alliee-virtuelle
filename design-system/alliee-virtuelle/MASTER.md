...
**Project:** Alliee Virtuelle
**Generated:** 2026-07-18 08:53:18
...
|------|-----|--------------|
| Primary | `#256BFF` | `--color-primary` |
| On Primary | `#FFFFFF` | `--color-on-primary` |
| Secondary | `#2F6FE0` | `--color-secondary` |
| Accent/CTA | `#256BFF` | `--color-accent` |
| Background | `#071426` | `--color-background` |
| Foreground | `#F7FBFF` | `--color-foreground` |
| Muted | `#122947` | `--color-muted` |
| Border | `#203A5D` | `--color-border` |
| Destructive | `#C9333F` | `--color-destructive` |
| Ring | `#76A8FF` | `--color-ring` |

**Color Notes:** Brand blue on navy. Amber is reserved for time, waiting and warnings; red is reserved for destructive/error states.
...
.input:focus {
  border-color: #76A8FF;
  outline: none;
  box-shadow: 0 0 0 3px rgba(118, 168, 255, 0.24);
}
```
